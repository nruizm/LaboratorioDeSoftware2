...
import co.unicauca.tallerpolimorfismo_nruizm_axquijano.modelo.*;
...
public static void leerViajes() {
    try {
        ...
        Viaje viaje3 = new ViajeIndividual("Popayán", "San Andres", 4250000, new SimpleDateFormat("dd/MM/yyyy").parse("01/07/2019"), new
